            ...
            <div className="experiment-theory-wrapper">
                <div className="experiment-theory-box" role="region" aria-label="Experiment 7 theory">
                    <div className="theory-top">
                        <h2 className="theory-title">Experiment 7 — Photon Loss (Loss ≠ Insecurity)</h2>
                    </div>

                    <div className="theory-body">
                        <p><strong>Concept — Photon Loss:</strong> Not all photons sent by Alice reach Bob.

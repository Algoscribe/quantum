...
import "./Experiment9.css"; // use a new css for exp2 (or point to Experiment1.css if you prefer)
  ...
  return (
    <div className="chart-wrapper">
      <div className="chart-title-outside">
        Detection Probability vs Photon Intensity
      </div>
      ...
      <div className="chart-card">
        <svg viewBox="0 0 800 400" className="chart-svg">
          ...
          {intensityLevels.map((p, i) => {
            const x = 140 + i * 160;
            const y =
              340 - (detectionProbability(p.mu) / 100) * 260;
            ...
            return (
              <g key={i}>
                <circle
                  ...
                  cy={y}
                  r={8}
                  fill={p.type === "Decoy" ? "#22c55e" : "#ef4444"}
                />
                <text
                  x={x}
                  y={365}
      ...
      <div className="experiment-theory-wrapper">
        <div className="experiment-theory-box" role="region" aria-label="Experiment 7 theory">
          ...
          <div className="theory-body">
            ...
            <h4>Why Decoy States Are Needed</h4>
            <ul>
              <li>Real lasers emit multiple photons.</li>
              <li>Eve can split multi-photon pulses without causing errors.</li>
              <li>This attack is invisible in standard BB84.</li>
            </ul>

            <h4>How Decoy States Stop Eve</h4>
            <ul>
              <li>Alice varies photon intensity (μ).</li>
              <li>Eve cannot know which pulses are decoys.</li>
              <li>Abnormal detection rates expose the attack.</li>
            </ul>

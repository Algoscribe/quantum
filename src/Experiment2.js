...
import "./Experiment2.css"; // use a new css for exp2 (or point to Experiment1.css if you prefer)
...
export default function Exp2BB84() {
  ...
  const [statusMessage, setStatusMessage] = useState(`Eve ON — ready to transmit ${numPhotons} photons`);
      ...
      <div className="experiment-theory-wrapper">
        <div className="experiment-theory-box" role="region" aria-label="Experiment 2 theory">
          <div className="theory-top">
            <h2 className="theory-title">Eavesdropper ON — Intercept-Resend (Experiment 2)</h2>
          </div>
          ...
          <div className="theory-body">
            ...
            <p>Demonstrate measurement disturbance, why no-cloning prevents invisible eavesdropping, and how QKD detects Eve.</p>
          </div>
        </div>
      </div>
          ...
          <section className="channel-hero">
            <div className="channel-stage">
              <QuantumChannel
                ...
                eveEnabled={true}                   /* EVE TURNED ON */
                eveInterceptPercent={eveLevel}      /* percent chance per photon (slider-controlled) */
                eveLevel={eveLevel}                 /* legacy prop kept */
                eveBasisMode={"random"}             /* Eve picks random basis */
                channelNoisePercent={channelNoisePercent}
                channelDistanceKm={channelDistanceKm}
                onMeasured={handleMeasured}
                registerControls={registerControls}
                forceMatchBases={false}             /* do NOT force bases in Experiment 2 */
              />
            </div>
          </section>
        </div>
